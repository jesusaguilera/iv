...
angular.module('definicionesModule', []).controller ('definicionesController', ['$scope', function($scope) { 
  $scope.definiciones = [
    ...
    {palabra:"Apotropaico", definicion:"Decho de un rito que por su carácter mágico se cree que aleja el mal o propicia el bien.(Hechar sal sobre los hombros, tocar madera, etc.)"},
    ...
    {palabra:"Bonhomía", definicion:"Cualidad de persona buena, pero algo ingenua. Afabilidad, sencillez, bondad y honradez."},
    ...
    {palabra:"Diégesis", definicion:"Relato, expoisición. Desarrollo de los hechos en una obra."},
    ...
    {palabra:"Embaír", definicion:"Distraer, entretener, engañar, hacer creer."},
    {palabra:"Visaje", definicion:"Gesto exagerado del rostro, especialmente por hábito o por enfermedad."},
    {palabra:"Socapa", definicion:"Pretexto que sirve para ocultar la intención de conseguir una cosa."},
    {palabra:"Facundo", definicion:"Fácil y desenvuelto en el hablar."},
    {palabra:"Marfuz", definicion:"Repudiado, desechado. / Falaz, mentiroso."},
    {palabra:"Fisiparidad", definicion:"Modo de reproducción consistente en dividir el cuerpo en dos parte las cuales se convierten en un nuevo ser."},
    {palabra:"Fisíparo", definicion:"Animal que se reproduce por fisiparidad."},
    {palabra:"Vestiglio", definicion:"Monstruo horrible y fantástico."},
    {palabra:"Albricias", definicion:"Regalo que se daba al primero que era portador de una buena noticia."},
    {palabra:"Eremítico", definicion:"Del ermitaño o relativo a ellos."},
    {palabra:"Belitre", definicion:"Pícaro de poca estimación."},
    {palabra:"Horcajadura", definicion:"Ángulo que forman las dos piernas en su nacimiento. / Entrepierna."},
    {palabra:"Cotufa", definicion:"Golosina."},
    {palabra:"Solícito", definicion:"Que pone atención y diligencia y amabiliad al entender o servir a alguien."},
    {palabra:"Palafrén", definicion:"Caballo manso que solían montar las damas."},
    {palabra:"Pelafustán", definicion:"Hargán despreciable e insignificante."},
    {palabra:"Endríago", definicion:"Personaje literario mezcla entre hombre, hidra y dragón."},
    {palabra:"Guedeja", definicion:"Melena."},
    {palabra:"Enhilar", definicion:"Poner en orden."},
    {palabra:"Ordenación", definicion:"Conjunto de normas, leyes o reglas."},
    ...
    {palabra:"Zarandajo", definicion:"Despreciable. / Vestido estrafalario. / Cosa sin valor. / Desperdicio de las reses." },
    ...
    {palabra:"Precedencia", definicion:"Circunstancia de preceder a una cosa o persona en el tiempo. Anterioridad, prioridad." },
    {palabra:"Reluctante", definicion:"Que muestra resistencia. Desobediente, reacio, opuesto." },
    {palabra:"Anómico", definicion:"Falto de normas." },
    {palabra:"Pastueño", definicion:"Dócil, que embieste suavemente." },
    {palabra:"Vaguido", definicion:"Turbado, o que padece vahídos. / Desvanecimiento." },
    {palabra:"Vahído", definicion:"Desvanecimiento, turbación breve del sentido por alguna indisposición." },
    {palabra:"Disciplinante", definicion:"Penitente que se mortifica con disciplinas./ Intrumento para azotar." },
    {palabra:"Hidrópico", definicion:"Insaciable. / Sediento en exceso." },
    {palabra:"Bergante", definicion:"Granuja, sinvergüenza, falta de escrúpulos y, en ocasiones, delicuente." },
    {palabra:"Astringente", definicion:"Que produce desecación y contracción de los tejidos del vientre y dificulta la evacuación de los excrementos. Ej: la manzana." },
    {palabra:"Falsía", definicion:"Falsedad, mentira, infidelidad, hipocresía." },
    {palabra:"Embeleco", definicion:"Engaño, mentira." },
    {palabra:"Bureo", definicion:"Diversión, juerga." },
    {palabra:"Narigante", definicion:"Narigudo." },
    {palabra:"Derrengado", definicion:"Que está torcido. / Persona que está muy cansada. Reventado. Baldado. Fatigado." },
    {palabra:"Mohíno", definicion:"Que está triste, abatido, disgustado, triste, melancólico." },
    {palabra:"Ganapán", definicion:"Hombre rudo y tosco." },
    {palabra:"Rucio", definicion:"Canoso, de color pardo claro, blanquecino./ Asno, burro." },
    ...
    {palabra:"Apotropaico", definicion:"Inteligencia, agudeza, perspicacia." },
    {palabra:"Concento", definicion:"Inteligencia, agudeza, perspicacia." },
    {palabra:"Baldaquín", definicion:"Cubierta sostenida por columnas construida con materiales valiosos." },
    {palabra:"Linajudo", definicion:"Persona que pertence a un linaje noble." },
    {palabra:"Avefría", definicion:"Persona de poco espíritu y viveza." },
    {palabra:"Emulgente", definicion:"Que conduce la sangre a los riñones. Emulsionante. Que facilita la mezcla." },
    {palabra:"Ímprobo", definicion:"Que es muy intenso y continudo." },
    {palabra:"Acibarar", definicion:"Causar amargura con algún pesar o disgusto." },
    {palabra:"Pancista", definicion:"Persona que se acomoda fácilmente a algo, o a las cosas en general." },
    {palabra:"Empellón", definicion:"Empujón fuerte dado por el cuerpo." },
    {palabra:"Irrigar", definicion:"Conducir las aguas a las tierras de labro mediante canales, acequias, etc." },
    {palabra:"Hogaño", definicion:"De este año o en esta época. Oposición a antaño." },
    {palabra:"Bonhomía", definicion:"De este año o en esta época. Oposición a antaño." },
